...
export function AboutPage() {
  return (
    <div className="container" style={{ paddingTop: '3rem', maxWidth: '800px' }}>
      <PageHeader 
        title="About CouponTail" 
        description="Learn how we source verified coupon codes and why CouponTail is independently run to help you save."
        icon={Sparkles}
      />
      <main className="glass-panel" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', lineHeight: '1.7' }}>
        ...
        <p style={{ color: 'var(--text-secondary)' }}>
          Welcome to <strong>CouponTail</strong>, your premier, independently-run platform for finding verified online coupons, deals, and discount codes. We are dedicated to building a cleaner, simpler, and more efficient way to shop online without breaking the bank.
        </p>
        ...
        <p style={{ color: 'var(--text-secondary)' }}>
          CouponTail is 100% independent. We are not owned by any major shopping portal or merchant conglomerate. This autonomy ensures that we put shoppers first, providing honest terms of coupon use and focusing solely on saving you money.
        </p>
      </main>
    </div>
  );
      ...
      {success ? (
        <div className="glass-panel" style={{
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: '1.6', maxWidth: '400px' }}>
            Thank you for reaching out to CouponTail. Your message has been saved. We will review it and reply within 24-48 business hours.
          </p>
        ...
        <div className="glass-panel" style={{ padding: '2.5rem' }}>
          ...
          <div style={{
            ...
            Alternatively, you can email support directly at: <strong style={{ color: 'var(--accent)' }}>support@coupontail.deals</strong>
          </div>
        </div>
      )}
    </div>
  ...
  return (
    <div className="container" style={{ paddingTop: '3rem', maxWidth: '800px' }}>
      <PageHeader 
        ...
        description="Please read these usage guidelines carefully before browsing or using CouponTail."
        icon={HelpCircle}
      />
      <main className="glass-panel" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', lineHeight: '1.7', color: 'var(--text-secondary)' }}>
        ...
        <p>
          By visiting, accessing, or browsing CouponTail, you acknowledge and agree to be bound by these terms. If you do not agree to these terms, please refrain from using our coupon discovery service.
        </p>

        <h2 style={{ color: '#fff', fontSize: '1.25rem', fontFamily: 'var(--font-headings)' }}>2. No Warranty on Validity</h2>
        <p>
          All coupon codes, deals, and promotions published on CouponTail are compiled for convenience and reference only. We make every effort to verify active deals, but we do <strong>not</strong> warrant or guarantee that any coupon code will be valid, active, or accepted at checkout. Brands reserve the right to modify or deactivate discount codes at their sole discretion at any time.
        </p>

        <h2 style={{ color: '#fff', fontSize: '1.25rem', fontFamily: 'var(--font-headings)' }}>3. User Verification Responsibility</h2>
        <p>
          It is your absolute responsibility as the shopper to verify that the discount has been successfully applied to your order in the merchant's shopping cart prior to completing the purchase or checkout process. CouponTail is not responsible for any purchases made at full price due to code deactivation.
        </p>

        <h2 style={{ color: '#fff', fontSize: '1.25rem', fontFamily: 'var(--font-headings)' }}>4. Third-Party Transactions & Liability</h2>
        <p>
          CouponTail lists codes but does not sell products. Any transactions you enter into are strictly between you and the respective third-party store (e.g. Amazon, Swiggy, Nike). We hold <strong>no liability</strong> or responsibility for shipping delays, customer service issues, product defects, or payment disputes originating from merchant websites.
        </p>
      </main>
    </div>
  );
  ...
  return (
    <div className="container" style={{ paddingTop: '3rem', maxWidth: '800px' }}>
      ...
      <main className="glass-panel" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', lineHeight: '1.7', color: 'var(--text-secondary)' }}>
        ...
        <p>
          CouponTail values your privacy. We collect:
        </p>
        ...
        <p>
          We use simple site cookies or local storage settings to remember layout selections (like recently copied coupons or theme settings). No tracking or behavioral advertisement cookies are implemented on CouponTail.
        </p>
      </main>
    </div>
  );
  ...
  return (
    <div className="container" style={{ paddingTop: '3rem', maxWidth: '800px' }}>
      ...
      <main className="glass-panel" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', lineHeight: '1.7', color: 'var(--text-secondary)' }}>
        ...
        <p>
          CouponTail is a public coupon aggregator. We are <strong>not</strong> officially affiliated with, endorsed by, partnered with, or sponsored by any of the brands listed on this website:
        </p>
        ...
        <p>
          All brand names, store logos, and registered trademarks featured or referred to on CouponTail belong to their respective owners. Their inclusion is purely nominative to identify the stores where the coupons are applicable, under fair use laws.
        </p>

        <h2 style={{ color: '#fff', fontSize: '1.25rem', fontFamily: 'var(--font-headings)' }}>Coupon Accuracy</h2>
        <p>
          While we check deals routinely, coupon codes are subject to instant modification or early removal by the merchant. CouponTail does not guarantee coupon accuracy, expiry validity, or availability. Shoppers proceed at their own discretion.
        </p>
      </main>
    </div>
  );
...
export function CookiePolicyPage() {
  return (
    <div className="container" style={{ paddingTop: '3rem', maxWidth: '800px' }}>
      <PageHeader 
        title="Cookie Policy" 
        description="A brief summary of how and why we utilize cookies on CouponTail."
        icon={Info}
      />
      <main className="glass-panel" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', lineHeight: '1.7', color: 'var(--text-secondary)' }}>
        ...
        <p>
          CouponTail uses cookies and local storage variables solely for necessary operations:
        </p>
        <ul style={{ paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
