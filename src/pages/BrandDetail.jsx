...
export default function BrandDetail() {
  ...
  useEffect(() => {
    if (formattedBrand) {
      document.title = `${formattedBrand} Coupons & Promo Codes - Verified Deals | CouponTail`;
      ...
      metaDesc.setAttribute('content', `Get the latest verified ${formattedBrand} coupons, promo codes, and discount offers. Shop and save today with CouponTail.`);
    }
  }, [formattedBrand]);
  ...
  const faqsList = [
    ...
    {
      q: `Is CouponTail officially affiliated with ${formattedBrand}?`,
        ...
        <section style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem' }}>
          ...
          <div style={{ maxWidth: '850px' }}>
            ...
            <p style={{ 
              ...
              To redeem one of our {formattedBrand} deals, simply click the copy code button on the card. CouponTail will copy 
